...
_EN = {
    ...
    # --- Streak card ---
    "streak.reached": "Tomorrow: day {n}",
    "streak.reached_today": "Goal reached today!",
    "streak.more_streak": "{left} more",
    "streak.more": "{n} more",
    "streak.not_started": "Have your first sip",
    "streak.cup_tip": "Today {done} / {target}",
    "streak.unit_days": "days",
    "streak.consecutive": "Consecutive",
    "streak.shields": "Shields",
    "grace.stats_countdown": "Streak at risk\n{left} more to save",
    "grace.stats_recovering": "Saved!",
    "grace.bubble_tip": "{n}-day streak at risk, {h}h {m}m left",
